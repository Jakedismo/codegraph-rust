...
FEATURES="embeddings,embeddings-local,embeddings-openai,embeddings-ollama,embeddings-jina,cloud,server-http,qwen-integration,ai-enhanced,codegraph-graph/surrealdb"
