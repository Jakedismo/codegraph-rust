...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo -e "${YELLOW}💡 Important Indexing Notes:${NC}"
    echo "   • First time: ${GREEN}codegraph index .${NC} works fine"
    echo "   • Reindexing: Use ${GREEN}--force${NC} flag to reprocess files"
    echo "   • Specific languages: ${GREEN}--languages swift,typescript,rust${NC}"
