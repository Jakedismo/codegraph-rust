...
impl QwenClient {
    ...
    /// Generate semantic analysis using Qwen2.5-Coder
    pub async fn analyze_codebase(&self, query: &str, context: &str) -> Result<QwenResult> {
        let start_time = Instant::now();

        let prompt = format!(
            "You are Qwen2.5-Coder providing comprehensive codebase analysis for MCP-calling LLMs.\n\n\
            ANALYSIS REQUEST: {}\n\n\
            CODEBASE CONTEXT:\n{}\n\n\
            Provide structured analysis that enables powerful LLMs to understand this codebase:\n\n\
            1. SEMANTIC_UNDERSTANDING: What functionality exists and how it works\n\
            ...
            5. GENERATION_GUIDANCE: How to generate code that fits this codebase\n\n\
            Be detailed and actionable for code generation and understanding.",
            query, context
        );
