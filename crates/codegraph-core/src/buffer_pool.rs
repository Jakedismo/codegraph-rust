...
impl BufferPool {
    pub fn new(config: BufferPoolConfig) -> Self {
        ...
        for _ in 0..config.capacity.min(16) {
            // warm a few by default
        ...
        Self {
            ...
            tracker: Arc::new(LeakTracker::new()),
        }
    }
    ...
    pub fn get(&self) -> PooledBuffer {
        ...
        let buf = inner
            .free
            .pop()
            .unwrap_or_else(|| Vec::with_capacity(inner.buffer_size));
...
impl LeakTracker {
    ...
    pub fn assert_no_leaks(&self) {
        ...
        debug_assert_eq!(
            *g, 0,
            "BufferPool leak detected: {} outstanding buffers",
            *g
        );
    }
}
