...
///
/// Note: Debug logging is handled by GraphToolExecutor itself - this adapter
/// is just a thin sync wrapper and should not duplicate logging.
...
impl GraphToolExecutorAdapter {
    ...
    ///
    /// Debug logging (tool_call_start/finish) is handled by GraphToolExecutor.
