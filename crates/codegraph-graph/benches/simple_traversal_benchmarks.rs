...
async fn create_simple_test_graph(node_count: usize, edge_density: f64) -> (CodeGraph, Vec<NodeId>) {
...
fn bench_graph_operations(c: &mut Criterion) {
    ...
    group.bench_function("add_edges_100", |b| {
        b.to_async(&rt).iter(|| async {
            ...
            let node1 = CodeNode::new(node_id1, "node1".to_string(), NodeType::Function, "/test/file1.rs".to_string());
            let node2 = CodeNode::new(node_id2, "node2".to_string(), NodeType::Function, "/test/file2.rs".to_string());
